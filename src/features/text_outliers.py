...
class TransformTextOutliers:
    ...
    def __init__(self, column_to_transform="text", model="en_core_web_en", word_count_threshold=250, sentence_normalization=True, similarity_threshold=0.8, factor=3, report_path="./src/features/TextOutlierReport.txt"):
