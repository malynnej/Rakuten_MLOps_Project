...
def create_holdout_json(num_samples: int = 100, output_name: str = "holdout_test_samples.json"):
    """
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--num_samples", type=int, default=100, help="Number of samples to extract (default: 100)"
    )
    parser.add_argument(
        "--output_name",
        type=str,
    ...
    create_holdout_json(num_samples=args.num_samples, output_name=args.output_name)
